<template>
  <div>
    <div style="padding: 5px;">
      ...
      <el-button type="success" @click="add()" v-if="!confirm&&headhide!=1&&headhide!=12&&headhide!=123&&headhide!=13&&headhide!=1234">添加</el-button>
      <el-button type="danger" @click="del()" v-if="!confirm&&headhide!=2&&headhide!=12&&headhide!=23&&headhide!=123&&headhide!=1234">删除</el-button>
      <el-button plain type="primary" @click="update()" v-if="!confirm&&headhide!=3&&headhide!=23&&headhide!=123&&headhide!=13&&headhide!=1234">修改</el-button>
      <el-button plain type="primary" @click="update()" v-if="!confirm&&headhide!=4&&headhide!=24&&headhide!=123&&headhide!=13">录入</el-button>
    ...
    <el-table ref="singleTable" :data="data"
      ...
      <el-table-column style="position: relative;"
                       ...
                       :width="value2(value)=='file'||value3(value)?150:null"
                       v-if="i>1" v-for="(value,key,i) in util">
        <template scope="scope">
          <img style="cursor: pointer;" class="form-avatar avatar"
               onerror="this.src='/onfail.png'"
               @dblclick="edit(scope.row, scope.$index)"
               v-if="!scope.row.input&&value2(value)&&value2(value)=='file'"
               :src="host+scope.row[key]"/>
          ...
          <el-input-number class="form-item" size="small"
                           v-if="scope.row.input&&value1(value)"
                           v-model="scope.row[key]">
          </el-input-number>
          <el-select class="form-item" size="small"
          ...
          <el-upload class="avatar-uploader form-avatar"
                     ...
                     v-if="scope.row.input&&value2(value)&&value2(value)=='file'">
            <img class="avatar" v-if="scope.row[key]" :src="host+scope.row[key]">
          ...
          <el-input class="form-item" size="small"
                    ...
                    v-model="scope.row[key]" :disabled="key=='id'||valTxt(value)<0"
